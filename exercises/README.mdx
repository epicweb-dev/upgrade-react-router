...
[v5 vs v6](https://upgrade-react-router.epicweb.dev/diff?app1=01.01.problem.v5&app2=50.01.problem.v6) and then [v6 vs v7](https://upgrade-react-router.epicweb.dev/diff?app1=50.01.problem.v6&app2=99.01.solution.v7).
